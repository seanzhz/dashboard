...
function DiscountProduct() {
    ...
    const [rowData] = useState(() =>
        Array.from({ length: 50 }, (_, index) => ({
            ...
            brand: ["Apple", "Nike", "Sony", "Samsung"][index % 4],
    ...
    const [colDefs] = useState([
        ...
        { field: "brand", headerName: "Brand", flex: 1.5 },
