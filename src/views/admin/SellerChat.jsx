        ...
        <div className='px-2 lg:px-7 pt-5 text-theme-text'>
            ...
            <div className="w-full p-4 bg-theme-bgSecondary rounded-md border border-theme-border">
                <div className="flex flex-col lg:flex-row h-[500px]">
                    {/* 联系人列表 */}
                    <div className="w-full lg:w-1/3 border-r border-theme-border p-4 overflow-auto bg-theme-bgSecondary">
                    ...
                    {/* 聊天区域 */}
                    <div className="flex-1 flex flex-col p-4 overflow-auto bg-theme-bgSecondary">
